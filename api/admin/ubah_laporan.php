            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    while ($result = mysqli_fetch_array($sql)) { ?>
                        ...
                        <div class="col-lg-12">
                            <h2>Form Ubah Laporan Kebakaran</h2>
                            <form action="action.php?id=<?php echo $result['id']; ?>" method="post">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="latitude" class="form-control" id="latitude" value="<?php echo $result['latitude']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%;"><label for="longitude">Longitude</label></td>
                                        <td><input type="text" name="longitude" class="form-control" id="longitude" value="<?php echo $result['longitude']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-danger"><i>*ket: n = belum, y = sudah verifikasi</i></td>
                                    </tr>
                                </table>
